...
<head>
    ...
    <!--=====TITLE=======-->
    <title>Justlaw || Contact Us</title>
    <!--=====FAV ICON=======-->
...
<body class="body1">
                        ...
                        <div class="header-elements">
                                ...
                                <ul>
                                    <li><a href="#">Home <i class="fa-solid fa-angle-down"></i></a>
                                        <ul class="dropdown-padding">
                                            <li class="main-small-menu"><a href="#">Multiple Page <i
                                                        class="fa-solid fa-angle-right"></i></a>
                                                <ul class="small-dropdown">
                                                    <li><a href="index-2.html" target="_blank">Criminal Defence Law</a>
                                                    </li>
                                                    <li><a href="index5.html" target="_blank">Personal Injury Law</a>
                                                    </li>
                                            ...
                                            <li class="main-small-menu"><a href="#">Landing Page <i
                                                        class="fa-solid fa-angle-right"></i></a>
                                                <ul class="small-dropdown">
                                                    <li><a href="single-index1.html" target="_blank">Criminal Defence
                                                            Law</a></li>
                                                    <li><a href="single-index5.html" target="_blank">Personal Injury
                                                            Law</a></li>
                                                    <li><a href="single-index3.html" target="_blank">Immigration Law</a>
                                                    </li>
                                                    <li><a href="single-index6.html" target="_blank">Corporate Law</a>
                                                    </li>
                                                    <li><a href="single-index4.html" target="_blank">Divorce Law</a>
                                                    </li>
                            ...
                            <div class="home2-header-buttons d-none d-md-block">
                                <div class="button2-all">
                                    <a href="contact.html" class="theme-btn6">Hire Now <span><i
            ...
            <div class="col-lg-12">
                <div class="mobile-header-elements">
                    <div class="mobile-logo">
                        <a href="index1.html"><img src="assets/img/logo/logo1.svg" alt=""></a>
                    </div>
    ...
    <div class="mobile-sidebar sidebar1 d-block d-lg-none">
        <div class="mobile-logo">
            <a href="index1.html"><img src="assets/img/logo/logo1.svg" alt=""></a>
        </div>
        ...
        <div class="mobile-nav">
            <ul>
                <li class="has-dropdown"><a href="#">Home </a>
                    <ul class="sub-menu">
                        <li class="has-dropdown has-dropdown1"><a href="index4.html">Multiple Page</a>
                            <ul class="sub-menu">
            ...
            <a class="mobile-menu-button" href="contact.html">Get Started</a>
        </div>
    ...
    <div class="inner-header-section"
        ...
        <img src="assets/img/shapes/hero1-shape1.svg" alt="" class="d-none shape1 aniamtion-key-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto">
                    <div class="about-inner-header text-center">
                        ...
                        <a href="index-2.html">Home <i class="fa-regular fa-angle-right"></i><span>Contact
                                Us</span></a>
                    </div>
                </div>
            </div>
    ...
    <!--===== CONTACT AREA STARTS =======-->
    <div class="contact4-section-area inner2 sp3">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="contact4-header-area hadding1">
                        ...
                        <div class="hour-content">
                            <h4>Work Hour</h4>
                            <ul>
                                <li><a href="#"><i class="fa-solid fa-calendar-days"></i> Tuesday - Saturday</a>
                                </li>
                                <li><a href="#"><i class="fa-regular fa-clock"></i> 8:00 Am - 5:00 Pm </a></li>
                            </ul>
                        </div>
                        <div class="space28"></div>
                        <div class="contact-all-area">
                            <div class="location-img">
                                <img src="assets/img/icons/location-img2.svg" alt="">
                            </div>
                        ...
                        <div class="contact-all-area">
                            ...
                            <div class="location-text">
                                <h4>My Number</h4>
                                <a href="tel:+92152226132">+921 5222 6132</a>
                            </div>
                        </div>
                        <div class="space32"></div>
                        <div class="contact-all-area">
                            <div class="location-img">
                                <img src="assets/img/icons/mail-img2.svg" alt="">
                            </div>
                            <div class="location-text">
                                <h4>My Mail</h4>
                                <a href="mailto:Demo@hexacure.com">Demo@hexacure.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="contact-form-area">
                        <form action="{{ route('form.submit') }}" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="contact-input-area">
                                        <button type="submit" class="theme-btn6 p-3 px-4">Send Now</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <!--===== CTA AREA STARTS =======-->
    <div class="cta6-section-area inner" style="background-color:#ECF6F7;">
        <img src="assets/img/shapes/vector3.png" alt="" class="vector2 keyframe5">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 m-auto">
                    <div class="cta6-header text-center ">
                        <h2 class="text-dark">Secure Your Defense: Schedule a Free Consultation Today</h2>
                        <div class="space16"></div>
                        <p class="text-dark">This CTA title invites readers to take action & seek the assistance corporate lawyer.</p>
                        <div class="space32"></div>
                        <form action="{{ route('form.submit') }}" method="POST">
                            @csrf
                            <input type="text" placeholder="Enter Your Email">
                            <button type="submit" class="theme-btn6">Schedule a Consultation <span><i
        ...
        <img src="assets/img/shapes/vector3.png" alt="" class="vector3 keyframe5">
    </div>
    <!--===== CTA AREA ENDS =======-->
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <div class="logo">
                        {{-- <a href="index-2.html"><img src="assets/img/logo/logo1.svg" alt=""></a> --}}
                    ...
                    <div class="footer-menu-list">
                        ...
                        <div class="footer-input ">
                            <div class="footer-input-area _relative">
                                ...
                                <button type="submit" style="background-color: #0B5D6A"><img src="assets/img/icons/footer-button.svg"
                                        alt=""></button>
                            </div>
                        </div>
                    </div>
